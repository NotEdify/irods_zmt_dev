        ...
        <Fragment>
              ...
              <Table aria-label="simple table">
                ...
                <TableBody>
                  <TableRow id="add-group-row" style={{ display: "none" }}>
                    <TableCell>
                      <Input
                        className={classes.add_group_name}
                    ...
                    <TableCell align="right">
                      <ToggleButtonGroup size="small">
                        <ToggleButton value="add" onClick={addGroup}>
                          <SaveIcon />
                        </ToggleButton>
                        ...
                        <TableRow key={group_id}>
                          ...
                          >
                            <Link
                              ...
                              to={`/groups/edit?groupInfo=${group}`}
                            >
          ...
          >
            ...
            <DialogActions>
              ...
              <Button onClick={handleRemoveFormClose} color="primary">
                Cancel
              </Button>
            </DialogActions>
          </Dialog>
